                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                @if (!$product->image_product->isEmpty())
                                    @foreach ($product->image_product as $image_product => $image)
                                        @once
                                            <img class="product-big-img" id="previewProduct" src="images/{{ $image->image }}"
                                                alt="product">
                                        @endonce
                                    @endforeach
                                @else
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    @if (!$product->image_product->isEmpty())
                                        @foreach ($product->image_product as $image_product => $image)
                                            <div class="pt active" data-imgbigurl="images/{{ $image->image }}">
                                        ...
                                        @foreach ($color_size_price as $color => $size_price)
                                            <div class="col-md-auto">
                                                <input type="radio" name="color" value="{{ $color }}"
                                                    @if ($color == array_key_first($color_size_price)) checked @endif class="btn-check"
                                                    id="{{ $color }}" hidden>
                                                <label for="{{ $color }}"
                                ...
                                <div class="tab-pane fade-in active" id="tab-1" role="tabpanel">
                                    <div class="customer-review-option">
                                        ...
                                        <div class="leave-comment">
                                            ...
                                            <form action="{{ Route('them-comment-user-page') }}" class="comment-form"
                                                method="POST">
                                                @csrf
                                                <div class="row">
                                                    <!-- <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-12">
                                                        @if (Auth::check())
                                                            ...
                                                            <button type="submit" readonly class="site-btn">Send
                                                                message</button>
                                                        @endif
                                                    </div>
                                                </div>
